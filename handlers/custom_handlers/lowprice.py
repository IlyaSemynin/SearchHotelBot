...
def low_price(message: Message) -> None:
    ...
    bot.send_message(
        ...
        f"{message.from_user.first_name}, вы выбрали команду для поиска "
...
def low_choice_currency(call) -> None:
    ...
    bot.set_state(
        call.from_user.id, LowPriceInfoState.currency_selection, call.message.chat.id
    )
