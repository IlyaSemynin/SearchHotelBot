...
[Телеграмм бот](@searchhotels_sb_bot) ищет отели в заданном пользователем городе используя API сайта Hotels.com используя API сайта [Hotels.com](https://hotels.com/).
